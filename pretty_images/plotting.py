...
if len(all_files) == 0:
    ...
    with open(filesourcename,'r') as f:
        ...
        for i in range(len(raw)/40):
            ...
            if tmp114 != '':
                prettymom2.main(tmp0,tmp110,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,tmp111,tmp10,tmp11,tmp12,tmp13,tmp14,tmp15,tmp100,tmp101,tmp102,tmp103,tmp104,tmp105,tmp106,tmp107,tmp108,tmp109,tmp112,tmp17,tmp18,tmp113,tmp114,tmp115,tmp116,tmp117,tmp118,tmp119)
